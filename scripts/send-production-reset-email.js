...
async function sendProductionResetEmail() {
  try {
    console.log('📧 Production Password Reset Email Sender\n');

    const testEmail = 'harsh.bagadiya@krishnaos.com';
    const productionUrl = 'https://4d-bim-web-application-harsh.vercel.app';
    ...
    console.log('');
    console.log('🔗 Production reset link (valid for 1 hour):');
    console.log('   ' + resetUrl);
    console.log('');
    console.log('🌐 Production URLs:');
    console.log('   Login: ' + productionUrl + '/login');
    console.log('   Forgot Password: ' + productionUrl + '/forgot-password');
